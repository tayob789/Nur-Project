...
export default function HomeScreen() {
  ...
  const { prayers, nextPrayer, nextPrayerIndex, loading, togglePrayer, hijriDate } = usePrayerTimes();
    ...
    <View style={s.root}>
      ...
      >
        <Animated.View style={{ opacity: fadeAnim }}>
          ...
          {/* Verse of the Day */}
          <LinearGradient colors={theme.gradients.zakatHeader} style={s.verseCard}>
...
const s = StyleSheet.create({
  ...
  avatarText: { fontSize: 20, color: theme.colors.gold },
  ...
  verseCard: { borderRadius: 18, padding: 18, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(61,140,124,0.25)' },
  verseEyebrow: { fontSize: 9, letterSpacing: 2, color: theme.colors.teal, marginBottom: 12, fontWeight: '600' },
  verseArabic: { fontSize: 22, color: theme.colors.goldLight, textAlign: 'right', writingDirection: 'rtl', marginBottom: 12, lineHeight: 36 },
  verseTranslation: { fontSize: 14, color: theme.colors.text, lineHeight: 22, fontStyle: 'italic', marginBottom: 8 },
  verseRef: { fontSize: 11, color: theme.colors.tealLight, fontWeight: '600' },
  hadithCard: { backgroundColor: theme.colors.surface, borderRadius: 18, padding: 18, marginBottom: 14, borderWidth: 1, borderColor: theme.colors.border },
