...
const s = StyleSheet.create({
  ...
  heroIcon: { width: 80, height: 80, borderRadius: 24, backgroundColor: theme.colors.goldDim, borderWidth: 1, borderColor: 'rgba(201,168,76,0.3)', justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  ...
  errCard: { backgroundColor: 'rgba(212,135,10,0.1)', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: 'rgba(212,135,10,0.3)', marginBottom: 14 },
