...
const s = StyleSheet.create({
  ...
  ramadanBanner: { backgroundColor: theme.colors.surface, borderRadius: 18, padding: 20, marginBottom: 14, borderWidth: 1, borderColor: theme.colors.goldBorder20 },
  ...
  privacyCard: { flexDirection: 'row', gap: 12, backgroundColor: theme.colors.tealDim, borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: theme.colors.tealBorder25, alignItems: 'flex-start' },
