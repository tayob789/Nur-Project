...
const s = StyleSheet.create({
  ...
  modal: { backgroundColor: theme.colors.surface2, borderRadius: 24, padding: 24, borderWidth: 1, borderColor: 'rgba(201,168,76,0.3)' },
  ...
  closeBtn: { backgroundColor: theme.colors.goldDim, borderRadius: 12, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(201,168,76,0.3)' },
